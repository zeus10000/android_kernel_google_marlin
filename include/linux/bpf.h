...
int btf_check_type_match(struct bpf_verifier_log *log, const struct bpf_prog *prog, struct btf *btf, const struct btf_type *t);
...
/* __cpu_map_flush moved to extern prototype */
